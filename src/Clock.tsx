	...
	<div id="clockface">
		<svg viewBox="0 0 200 200" width="95vh">
			<g transform="translate(100, 100)">
				...
				<circle r="3.1" fill="#701" stroke="#701" />
			</g>
		</svg>
	</div>
);

export const DimmerOne: Component = () => (
...
export const DimmerTwo: Component = () => (
	<button
		class="dimmer-btn btn-2"
		onClick={() => {
			const clock = document.querySelector("#clockface");
			if (clock) clock.classList.toggle("dimmed_02");
		}}
	>
		Dim 0.2
	</button>
